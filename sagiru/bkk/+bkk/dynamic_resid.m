...
residual(5) = lhs - rhs;
lhs = T(5)*params(4)*params(11)/y(21);
rhs = y(43);
residual(6) = lhs - rhs;
lhs = (-params(2))*T(5)*(1-params(4))*params(11)/y(22);
rhs = T(7)*T(6)*T(34);
residual(7) = lhs - rhs;
lhs = params(10)*y(43)+params(10)*params(1)*y(69)+T(25)+T(26)-(1-params(9))*params(10)*params(1)*y(69)-(1-params(9))*T(25)-(1-params(9))*T(26)-(1-params(9))*params(10)*T(10)*y(72);
rhs = y(75);
residual(8) = lhs - rhs;
lhs = y(43);
rhs = params(1)*y(69)*(1+T(11)*T(12));
residual(9) = lhs - rhs;
lhs = y(28)-1;
...
residual(16) = lhs - rhs;
lhs = T(17)*params(16)*params(23)/y(32);
rhs = y(43);
residual(17) = lhs - rhs;
lhs = (-params(14))*T(17)*(1-params(16))*params(23)/y(33);
rhs = T(19)*T(18)*T(39);
residual(18) = lhs - rhs;
lhs = y(43)*params(22)+params(22)*y(69)*params(13)+T(28)+T(29)-(1-params(21))*params(22)*y(69)*params(13)-(1-params(21))*T(28)-(1-params(21))*T(29)-(1-params(21))*params(22)*T(22)*y(72);
rhs = y(78);
residual(19) = lhs - rhs;
lhs = y(43);
rhs = y(69)*params(13)*(1+T(23)*T(24));
residual(20) = lhs - rhs;
lhs = y(39)-1;
