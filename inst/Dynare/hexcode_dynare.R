...
#
hexSticker::sticker("Dynare.png",h_fill = "#FFFFFF",package = "R",s_width =0.5,s_height = 0.5,s_x = 0.9,s_y = 1,p_color = "#F44646",spotlight=T,p_y = 1.02,p_x = 1.4,p_size = 25,h_color = "#2285C5",white_around_sticker=T,url="www.smati.com.ng",u_size = 4,u_y = 0.18,u_x = 1.2,p_family="serif",p_fontface = "bold",filename = "DynareR.png")
